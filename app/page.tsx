...
const products = [
  ...
  {
    id: 4,
    name: "Combo 3 Sản Phẩm",
    price: 220000,
    originalPrice: 280000,
    image: "/images/nem-nam.png",
    rating: 4.9,
    reviews: 89,
    description: "Combo gồm nem nắm (0.5kg), bột sắn (1kg), bột nghệ (0.5kg) - tiết kiệm hơn khi mua lẻ",
    badge: "Tiết kiệm",
    unit: "combo",
    stock: 30,
    category: "Combo",
  ...
  },
  {
    ...
    rating: 4.9,
    reviews: 42,
    description: "Bột nghệ đen quý hiếm, nhiều dưỡng chất, thích hợp làm đẹp và sức khỏe",
    badge: "Cao cấp",
    unit: "kg",
    stock: 35,
    category: "Bột Nghệ",
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
              {[
                ...
                },
                {
                  icon: Mail,
                  title: "Email",
                  info: "info@sanphamquenha.vn",
                  description: "Phản hồi trong 2h",
                },
                {
                  icon: MapPin,
                  title: "Địa chỉ",
                  info: "123 Đường ABC, TP.HCM",
